namespace assignment8ex1
{
    class Program
    {
        ...
        {
            Program.function sun = new Program.function(HereComesTheSun.chorus);
            sun += HereComesTheSun.verse1;
            sun += HereComesTheSun.chorus;
            sun += HereComesTheSun.verse2;
            sun += HereComesTheSun.chorus2;
            sun += HereComesTheSun.verse3;
            sun += HereComesTheSun.chorus;
            sun += HereComesTheSun.chorus;
            sun += HereComesTheSun.end;
