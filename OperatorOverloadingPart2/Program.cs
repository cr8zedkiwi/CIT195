...
namespace Assignment9ex2Operatoroverloading
{
    public class Log
    {
        ...
        public static Log operator +(Log obj, double hoursToAdd)
        {
            obj.Hours += hoursToAdd;
            return obj;
        }

        public static Log operator -(Log obj, double hoursToSubtract) 
        {
            obj.Hours -= hoursToSubtract;
            return obj;
